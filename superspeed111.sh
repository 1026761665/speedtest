...
speed_test(){
	...
	true > $speedLog
		...
		if [[ ${is_upload} ]]; then
	        local REDownload=$(cat $speedLog | awk -F ' ' '/Download/{print "%.2f" $3}')
		local REDownload1=$(cat $speedLog | awk -F ' ' '/Download/{printf "%.0f", $3/8}' | awk '{print int($1)}')
	        local reupload=$(cat $speedLog | awk -F ' ' '/Upload/{print $3}')
		local reupload1=$(cat $speedLog | awk -F ' ' '/Upload/{printf "%.0f", $3/8}' | awk '{print int($1)}')
...
runtest() {
	...
	if [[ ${selection} == 1 ]]; then
		...
		speed_test '4547' '广东深圳电信' '电信'
		speed_test '37089' '广东广州联通' '联通'
		speed_test '4623' '广东佛山电信' '电信'
		speed_test '5083' '广东东莞电信' '电信'
		speed_test '4899' '广东惠州电信' '电信'
		speed_test '33015' '广东汕头电信' '电信'
		speed_test '27628' '广东梅州电信' '电信'
		speed_test '27594' '广东广州５Ｇ' '电信'
		speed_test '31794' '广东肇庆联通' '联通'
		speed_test '27584' '广东珠海电信' '电信'
		speed_test '33470' '广东阳江电信' '电信'
		speed_test '27616' '广东揭阳联通' '联通'
		speed_test '31666' '广东湛江电信' '电信'
		speed_test '32826' '广东河源电信' '电信'
		speed_test '36425' '广东清远电信' '电信'
		speed_test '31776' '广东韶关电信' '电信'
		speed_test '27605' '广东汕尾电信' '电信'
		speed_test '27636' '广东潮州电信' '电信'
		speed_test '28185' '广东茂名电信' '电信'
		speed_test '33025' '广东梅州联通' '联通'
